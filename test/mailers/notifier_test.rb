...
class NotifierTest < ActionMailer::TestCase
  def test_admin_user_reset_password
    ...
    assert_equal ["it@myperfectweekend.com"], email.from
    assert_equal ["admin@email.com"], email.to
    assert_equal "[MyPerfectWeekend] Password reset", email.subject
  ...
  def test_simple_test_email
    ...
    assert_equal "[MyPerfectWeekend] Wadus", email.subject
